...
<table class="order-data-addresses">
	<tr>
		<td class="customer">
			...
			$raw_phone = $order_meta['_shipping_phone'][0]; 
			$formatted_phone = "(" . substr($raw_phone, 0, 3) . ") " . substr($raw_phone, 3, 3) . " - " . substr($raw_phone, 6, 4); ?>
				<div class="billing-phone"><?php _e($formatted_phone) ?></div>
				<br />
			<?php } 
