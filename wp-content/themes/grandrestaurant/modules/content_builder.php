...
?>
	...
	<div id="ppb_page_content">
		<div class="ppb_page_title_bar">
			<div class="ppb_page_title">
				<a id="ppb_open_dev_bar" title="<?php esc_html_e('Developer View', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-list-view"></span></a>
				
				<a id="ppb_open_templates" title="<?php esc_html_e('Templates', THEMEDOMAIN ); ?>" href="#ppb_template" class="pp_fancybox_inline"><span class="dashicons dashicons-book-alt"></span></a>
				
				<a id="ppb_preview_page" title="<?php esc_html_e('Preview', THEMEDOMAIN ); ?>" data-action="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb_preview_page_set_data')); ?>" data-preview="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb_preview_page&ppb_post_type=page&page_id='.$post->ID)); ?>" data-page="<?php echo esc_attr($post->ID); ?>"><span class="dashicons dashicons-admin-site"></span></a>
			...
			<div class="ppb_page_action">
				<a id="ppb_undo" title="<?php esc_html_e('Undo', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-undo"></span></a>
				
				<a id="ppb_redo" title="<?php esc_html_e('Redo', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-redo"></span></a>
			
				<a id="ppb_page_unsaved" class="tooltipster" class="tooltipster" title="<?php echo esc_html__('Unsaved Page Content.', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-info"></span></a>
			
				<a id="ppb_live" title="<?php esc_html_e('Live View', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-desktop"></span></a>
				
				<a id="ppb_classic" title="<?php esc_html_e('Classic View', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-editor-insertmore"></span></span></a>
				
				<a id="ppb_refresh" title="<?php esc_html_e('Refresh', 'grandconference' ); ?>"><span class="dashicons dashicons-image-rotate"></span></a>
				
				<a id="ppb_add" title="<?php esc_html_e('Add Content', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-plus"></span></a>
				
				<a id="ppb_save" title="<?php esc_html_e('Saved', THEMEDOMAIN ); ?>" data-saved-title="<?php esc_html_e('Saved', THEMEDOMAIN ); ?>" data-save-title="<?php esc_html_e('Save Changes', THEMEDOMAIN ); ?>" href="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb_save_page_builder&page_id='.$post->ID)); ?>" class="inactive"><span class="dashicons dashicons-download"></span><span class="ppb_live_button_title"><?php esc_html_e('Saved', THEMEDOMAIN ); ?></span></a>
				
				<a href="<?php echo BUILDERDOCURL; ?>" class="tooltipster" target="_blank" id="ppb_help" title="<?php esc_html_e('Content Builder Documentation', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-editor-help"></span></a>
			</div>
		</div>
		<br class="clear"/>
	...
	<div id="ppb_page_title_header">
		<div class="ppb_page_title_wrapper">
			<div class="ppb_page_sub_title"><?php esc_html_e('You are editing', THEMEDOMAIN ); ?></div>
	...
	?>
	    	<li id="<?php echo esc_attr($ppb_form_item); ?>" class="ui-state-default <?php echo esc_attr($ppb_form_item_size[0]); ?> <?php echo esc_attr($ppb_form_item_data_obj->shortcode); ?>" data-current-size="<?php echo esc_attr($ppb_form_item_size[0]); ?>" data-shortcode="<?php echo esc_attr($ppb_shortocde_title); ?>" data-icon="<?php echo esc_url($ppb_shortcode_icon); ?>">
	    		...
	    		<div class="item_action">
		    		<div class="size">
		    			<a href="javascript:;" title="<?php esc_html_e('Expand', THEMEDOMAIN ); ?>" class="ppb_plus button"><span class="dashicons dashicons-plus"></span></a>
		    			<a href="javascript:;" title="<?php esc_html_e('Contract', THEMEDOMAIN ); ?>" class="ppb_minus button"><span class="dashicons dashicons-minus"></span></a>
		    		</div>
	    			<a href="javascript:;" class="ppb_remove" title="<?php esc_html_e('Remove', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-no"></span><?php esc_html_e('Remove', THEMEDOMAIN ); ?></a>
					
					<a href="javascript:;" class="ppb_duplicate" title="<?php esc_html_e('Duplicate', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-admin-page"></span><?php esc_html_e('Duplicate', THEMEDOMAIN ); ?></a>
					
					<a data-rel="<?php echo esc_attr($ppb_form_item); ?>" href="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb&ppb_post_type=page&shortcode='.$ppb_form_item_data_obj->shortcode.'&rel='.$ppb_form_item.'&width=800&height=900&page_id='.$post->ID)); ?>" class="ppb_edit" title="<?php esc_html_e('Edit', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-welcome-write-blog"></span><?php esc_html_e('Edit', THEMEDOMAIN ); ?></a>
					
					<a data-rel="<?php echo esc_attr($ppb_form_item); ?>" href="javascript:;" class="ppb_add_after" title="<?php esc_html_e('Add', THEMEDOMAIN ); ?>"><span class="dashicons dashicons-arrow-down-alt"></span><?php esc_html_e('Add', THEMEDOMAIN ); ?></a>
	    		</div>
	...
	<div id="ppb_add_content_wrapper" <?php if(!empty($count_ppb)) { ?>class="not_started"<?php } ?>>
	    ...
	    <div id="ppb_add_content_wrapper_started">
	    	<h3><?php esc_html_e('Get started', THEMEDOMAIN ); ?></h3>
	    	<div class="ppb_tagline"><?php esc_html_e('Currently you have no content. Start adding content by clicking button below', THEMEDOMAIN ); ?></div>
	    </div>
	    <?php
	    	}
	    ?>
	    
	    <a id="ppb_sortable_add_button" href="#ppb_tab" class="pp_fancybox_inline_fullheight" data-after=""!><span class="dashicons dashicons-plus-alt"></span><?php esc_html_e('Add Content', THEMEDOMAIN ); ?></a>
	    ...
	    <?php
	    	...
	    	{
	    ?>
	    <a id="ppb_sortable_template_button" href="#ppb_template" class="pp_fancybox_inline"><span class="dashicons dashicons-download"></span><?php esc_html_e('Import Template', THEMEDOMAIN ); ?></a>
	    <?php
	    	}
	    ?>
	</div>
	...
	?>
	    	jQuery(window).bind('beforeunload', function(){
	    		...
	    		{
	    	    	return '<?php esc_html_e('There are unsaved content builder settings', THEMEDOMAIN ); ?>';
	    	    }
	    	});
	});
	...
	<div id="ppb_live_preview_frame_wrapper" rel="ppb_preview_desktop">
		<iframe id="ppb_live_preview_frame" data-action="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb_preview_page_set_data')); ?>" data-preview="<?php echo esc_url($preview_url); ?>"></iframe>
	</div>
