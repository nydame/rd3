...
<div class="social_wrapper">
    <ul>
        ...
        <?php
		    ...
		    {
		?>
		<li class="tripadvisor"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Tripadvisor" href="<?php echo $pp_tripadvisor_url; ?>"><i class="fa fa-tripadvisor"></i></a></li>
		<?php
		    }
		?>
		<?php
		    ...
		    {
		?>
		<li class="yelp"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Yelp" href="<?php echo $pp_yelp_url; ?>"><i class="fa fa-yelp"></i></a></li>
		<?php
		    }
		?>
    </ul>
