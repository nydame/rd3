...
**WooCommerce App Support Using Order Note:** The plugin add delivery information in order note. The feature is super handy becuase WooCommerce app doesn't allow any custom information. So if you control your order using WooCommerce app, you don't need to worry about Delivery details.
