...
?><div id="giftcard__container">
	...
	<div id="giftcard__card">
		...
		<?php else: ?>
			<a href="<?php echo esc_attr( add_query_arg( array( 'do_email_session' => urlencode( $giftcard->get_hash() ) ), apply_filters( 'woocommerce_gc_email_received_action_button_url', site_url(), $giftcard ) ) ); ?>" id="giftcard__action-button"><?php echo apply_filters( 'woocommerce_gc_email_received_action_button_text', esc_html_x( 'SHOP NOW', 'Email gift card received', 'woocommerce-gift-cards' ), $giftcard ); ?></a>
