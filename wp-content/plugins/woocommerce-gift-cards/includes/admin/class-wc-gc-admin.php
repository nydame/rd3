	...
	protected static function get_privacy_policy_guide_message() {
		...
		$content = '
			<div class="wp-suggested-text">' .
				...
				'</ul>' .
				'<p class="privacy-policy-tutorial">' .
					__( 'This information can be used to personally identify the sender and recipient(s). It is stored indefinitely.', 'woocommerce-gift-cards' ) .
				'</p>' .
				'<p class="privacy-policy-tutorial">' .
				...
				'</p>' .
				'<p class="privacy-policy-tutorial">' .
					__( 'Remember that Store Administrators have access to finanical assets: Gift card codes are cash equivalents.', 'woocommerce-gift-cards' ) .
				'</p>' .
			'</div>';
