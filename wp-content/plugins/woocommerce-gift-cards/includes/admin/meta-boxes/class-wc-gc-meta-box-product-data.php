...
class WC_GC_Meta_Box_Product_Data {
	...
	public static function add_on_boarding_notice() {
		...
		if ( isset( $_GET[ 'todo' ] ) && 'giftcard' === $_GET[ 'todo' ] ) {
			WC_GC_Admin_Notices::add_notice( __( 'You are almost ready to start selling your first Gift Card! To speed things up for you, we have already checked the <strong>Product Data > Gift Card</strong> option.', 'woocommerce-gift-cards' ), 'woocommerce woocommerce-message', false );
		}
	}
