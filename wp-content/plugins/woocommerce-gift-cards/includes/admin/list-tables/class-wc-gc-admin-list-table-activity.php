...
class WC_GC_Activity_List_Table extends WP_List_Table {
	...
	public function column_gc_code( $item ) {
		...
		$actions = array(
			'edit'       => sprintf( '<a href="' . admin_url( 'admin.php?page=gc_giftcards&section=edit&giftcard=%d' ) . '">%s</a>', $item[ 'gc_id' ], __( 'View Gift Card', 'woocommerce-gift-cards' ) ),
		);
	...
	public function get_columns() {
		...
		$columns[ 'type' ]     = _x( 'Event type', 'column_name', 'woocommerce-gift-cards' );
